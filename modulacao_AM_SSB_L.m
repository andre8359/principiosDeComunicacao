function sinal_modulado = modulacao_AM_SSB_L(sinal,fs,f_portadora,Ac)

	%Função que gera os graficos e retorna o sinal modulado em AM SSB L com a 
	...
	plot_sinal(sinal_modulado,'Sinal Modulado SSB L','Tempo [s]','Amplitude normalizada',4e5);
